  ...
  theme: {
  	...
  	extend: {
  		...
  		keyframes: {
  			...
  			'glow-pulse': {
  				'0%, 100%': {
  					boxShadow: '0 0 10px hsl(282 100% 36% / 0.3)'
  				},
  				'50%': {
  					boxShadow: '0 0 25px hsl(282 100% 36% / 0.5)'
  				}
  			},
  			'float': {
  				'0%, 100%': {
  		...
  		animation: {
  			...
  			'float-slow': 'float-slow 40s ease-in-out infinite',
  			'float-slower': 'float-slower 50s ease-in-out infinite',
  			'float-slowest': 'float-slowest 60s ease-in-out infinite'
  		},
  		backgroundImage: {
