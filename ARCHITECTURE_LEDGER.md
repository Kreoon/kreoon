...
- [ ] Academia mobile-first + reorganización de menús (Fase 3.5 Bloque 4) — NO hecho, necesita la captura de pantalla real para no adivinar decisiones de UI. Gating de rol ya verificado correcto para el modelo de datos actual (ver BUGS/UPDATES).
