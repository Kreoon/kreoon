-- =====================================================
-- FIX: Usar estados correctos de contenido
-- Migration: 20260305310000_fix_unified_stats_status
-- Estados válidos: approved, delivered, paid, corrected
-- =====================================================
...
BEGIN
    ...
    -- Estados que indican trabajo completado: approved, delivered, paid, corrected
    BEGIN
        SELECT COUNT(*)
        ...
        WHERE creator_id = p_user_id
        AND (
            status::text IN ('approved', 'delivered', 'paid', 'corrected')
