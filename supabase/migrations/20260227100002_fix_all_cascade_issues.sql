-- Fix all cascade issues: VIEWs, partner_communities FKs, and use WHEN OTHERS
...
BEGIN
  ...
  BEGIN DELETE FROM campaign_applications WHERE creator_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  ...
  BEGIN DELETE FROM creator_availability WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  -- creator_availability_status is a VIEW, skip
  ...
  IF wallet_ids IS NOT NULL THEN
    ...
    BEGIN DELETE FROM escrow_holds WHERE from_wallet_id = ANY(wallet_ids) OR to_wallet_id = ANY(wallet_ids); EXCEPTION WHEN OTHERS THEN NULL; END;
  ...
  BEGIN DELETE FROM point_transactions WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  deleted_tables := array_append(deleted_tables, 'finance');

  BEGIN DELETE FROM reputation_events WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM user_reputation_totals WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM marketplace_reputation WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM reputation_global WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  ...
  BEGIN DELETE FROM up_creadores WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM up_editores WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM up_creadores_totals WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM up_editores_totals WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  ...
  BEGIN DELETE FROM user_achievements WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM user_points WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  ...
  BEGIN DELETE FROM social_notifications WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  ...
  BEGIN DELETE FROM chronometer_pauses WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM up_chronometer_pauses WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM up_events WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM up_quest_progress WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM up_season_snapshots WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM up_user_scores WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  BEGIN DELETE FROM up_fraud_alerts WHERE user_id = target_user_id; EXCEPTION WHEN OTHERS THEN NULL; END;
  ...
  -- organization_ambassadors is a VIEW, skip
