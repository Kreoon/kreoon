-- =====================================================
-- Agregar campo gender a get_full_user_detail
-- Migration: 20260305710000_add_gender_to_user_detail_rpc
-- =====================================================

-- Eliminar función existente
DROP FUNCTION IF EXISTS get_full_user_detail(UUID);

-- Recrear la función con el campo gender incluido
...
DECLARE
  ...
  arrays_data JSONB;
BEGIN
  -- Part 1: Basic profile fields (incluye nationality, date_of_birth, username, gender)
