-- Fase 1.4: get_feed_posts.p_viewer_id necesita default null para soportar visitantes
-- anonimos (feed publico sin sesion, Fase 3) y para que el codegen de tipos TS marque el
-- parametro como opcional en vez de requerido.
