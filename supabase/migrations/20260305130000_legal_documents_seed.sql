...
INSERT INTO legal_documents (
  ...
  'Acuerdo de Creador',
  'Creator Agreement',
  'Términos específicos para creadores: CESIÓN TOTAL de derechos patrimoniales a SICOMMER INT LLC (sin límite temporal ni territorial), autorización irrevocable de uso de imagen/voz/likeness, pagos, comisiones, y sistema UP.',
...
INSERT INTO legal_documents (
  ...
  'Términos para marcas y clientes: LICENCIA DE 1 AÑO (renovable) para contenido con creadores, PROPIEDAD TOTAL para desarrollo/diseño, escrow, renovaciones, y responsabilidades.',
  '<!-- Ver archivo HTML completo en src/pages/legal/content/brand_agreement_v1.html -->',
  true,
  true,
  ARRAY['brand', 'client'],
  NOW()
