-- =====================================================
-- Add platform_access_unlocked to users RPC
-- Migration: 20260226100003_add_platform_access_to_users_rpc
-- Purpose: Allow CRM to see which users need referral keys
-- =====================================================
