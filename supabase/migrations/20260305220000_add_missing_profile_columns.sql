...
-- Migration: 20260305220000_add_missing_profile_columns
-- =====================================================
...
-- Comentarios
COMMENT ON COLUMN profiles.is_banned IS 'Usuario bloqueado de la plataforma';
COMMENT ON COLUMN profiles.is_platform_admin IS 'Usuario es administrador de plataforma';

-- Recrear la función get_full_user_detail con manejo seguro de columnas
