-- Fix active_projects in get_unified_clients:
-- Before: counted content items with non-terminal status (wrong — showed video count)
-- After: counts client_packages (real campaigns/packages contracted)
...
BEGIN
  ...
  -- Empresas (clientes directos de la org)
  SELECT
    c.id,
