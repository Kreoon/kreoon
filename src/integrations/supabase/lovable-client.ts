/**
 * Lovable Cloud Client - For Edge Functions
 * 
 * This client connects to Lovable Cloud (the hosting platform) for edge functions,
 * while the main database operations use the Kreoon external project.
 * 
 * Use this client ONLY for invoking edge functions.
