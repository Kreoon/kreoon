      ...
      <div className="relative max-w-2xl mx-auto px-4 py-12 sm:py-16">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl font-bold text-foreground mb-4 uppercase tracking-tighter"
          >
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <Card className="bg-card border-border shadow-none rounded-[0.125rem] p-6">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <Card className="bg-card border-border border p-6 rounded-[0.125rem] shadow-none">
            <h2 className="text-lg font-semibold text-foreground mb-4">Siguientes pasos</h2>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-[0.125rem] bg-purple-500/30 flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Agrega tu foto, bio y especialidades para que las marcas te encuentren</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-[0.125rem] bg-secondary flex items-center justify-center shrink-0 mt-0.5 border border-border">
                  <span className="text-xs font-bold text-muted-foreground">2</span>
                </div>
                <div>
                  <p className="font-medium text-foreground/80">Sube tu portafolio</p>
                  <p className="text-sm text-muted-foreground">Muestra tu mejor trabajo para destacar</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-[0.125rem] bg-secondary flex items-center justify-center shrink-0 mt-0.5 border border-border">
                ...
                <div>
                  <p className="font-medium text-foreground/80">Obtén tus llaves</p>
                  <p className="text-sm text-muted-foreground">Invita a 3 creadores y desbloquea todo KREOON</p>
                </div>
              </div>
            </div>
          </Card>
        ...
        <motion.p
          ...
          className="text-center text-xs text-muted-foreground/30 mt-12 font-mono uppercase"
        >
