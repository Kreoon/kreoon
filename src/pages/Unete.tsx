...
const USER_TYPE_CARDS: UserTypeCard[] = [
  ...
  },
  {
    ...
    description: 'Accede a talento verificado para tu contenido. Gestiona proyectos, pagos y resultados en un solo lugar.',
    icon: Building2,
    gradient: 'from-blue-600 to-cyan-600',
    borderColor: 'border-blue-500/30',
    route: '/unete/marcas',
    features: ['Talento verificado', 'Gestión de proyectos', 'Métricas en tiempo real', 'Pagos seguros'],
  },
  {
    type: 'organization',
  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="bg-white/10 border border-white/20 rounded-sm px-4 py-2 text-sm text-white">
...
function UserTypeCardComponent({
  ...
  return (
    <motion.div
      ...
      onClick={handleClick}
      className={`group relative cursor-pointer rounded-sm border ${card.borderColor} bg-white/5 p-6 md:p-8 transition-all duration-300 hover:bg-white/10 hover:border-white/30 hover:scale-[1.02] hover:shadow-2xl`}
    >
