  ...
  return (
    <div className="fixed inset-0 z-[100]">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="relative bg-[#0f0f1a] border border-white/10 rounded-2xl w-full max-w-md p-8 text-center">
          {/* Celebration icon */}
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="w-full border border-white/10 text-gray-400 py-3 rounded-xl hover:bg-white/5 transition-colors text-sm flex items-center justify-center gap-2"
            >
