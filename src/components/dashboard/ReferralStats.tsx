...
import { Users, DollarSign, UserPlus, TrendingUp, Gift, CheckCircle, Clock, XCircle } from "lucide-react";
...
export function ReferralStats() {
  ...
  const fetchData = async () => {
    try {
      // Fetch all referrals with referrer info
        ...
        <Card className="border-info/30">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-info/20 text-info text-lg px-3 py-1">Básico</Badge>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-primary/30">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <Badge className="bg-primary/20 text-primary text-lg px-3 py-1">Pro</Badge>
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              {subscriptions.length === 0 ? (
                <p className="text-center text-muted-foreground py-8">No hay suscripciones registradas</p>
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableRow key={sub.id}>
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">{sub.profile?.full_name || 'Desconocido'}</span>
                          </div>
                        </TableCell>
