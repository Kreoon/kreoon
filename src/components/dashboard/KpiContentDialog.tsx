...
export const KpiContentDialog = forwardRef<HTMLDivElement, KpiContentDialogProps>(
  function KpiContentDialog({ title, content, open, onOpenChange, onSelectContent }, ref) {
    ...
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent ref={ref} className="max-w-2xl max-h-[80vh]">
          <DialogHeader>
