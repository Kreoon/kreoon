...
export function DroppableKanbanColumn({ 
  ...
  return (
    <div 
      className={cn(
        "flex flex-col min-w-[300px] max-w-[300px] rounded-lg transition-all duration-200",
    ...
    >
      ...
      <div className="flex flex-col gap-3 flex-1 overflow-y-auto pr-2 pb-4 min-h-[200px]">
        {children}
      </div>
    </div>
  );
