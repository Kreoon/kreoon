  ...
  if (usuarios.length === 0) {
    ...
    return (
      <div className={cn('flex flex-col items-center justify-center py-12 text-center', className)}>
        ...
        <h3 className="text-lg font-semibold text-muted-foreground">{emptyMessage.titulo}</h3>
        <p className="text-sm text-muted-foreground">{emptyMessage.descripcion}</p>
      </div>
    );
  }
    ...
    <div className={cn('flex flex-col gap-4', className)}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-foreground text-lg">Ranking del Estudio</h3>
        </div>
      ...
      <div className="w-8 flex items-center justify-center">
        {user.posicion === 1 ? (
          ...
          <span
            className={cn(
              'font-bold text-lg',
              medalStyle?.text || 'text-muted-foreground'
            )}
          >
            #{user.posicion}
          </span>
