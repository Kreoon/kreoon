...
export function CreateContentDialog({ open, onOpenChange, onSuccess }: CreateContentDialogProps) {
  ...
  useEffect(() => {
    const isOrgAsClient = isInternalBrand(clientId);
