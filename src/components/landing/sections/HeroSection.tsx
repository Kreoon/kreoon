        ...
        >
          <div className="hero-3d-element relative w-full max-w-lg">
            ...
            <motion.div
              ...
              className="relative rounded-sm border border-kreoon-purple-500/30 bg-kreoon-bg-card/80 p-6 shadow-kreoon-glow-sm backdrop-blur-xl"
            >
            ...
            <motion.div
              ...
              className="absolute -right-2 top-4 rounded-sm border border-kreoon-purple-500/25 bg-kreoon-bg-card/70 px-4 py-3 backdrop-blur-md md:right-8"
            >
            ...
            <motion.div
              ...
              className="absolute bottom-8 left-0 rounded-sm border border-kreoon-purple-500/25 bg-kreoon-bg-card/70 px-4 py-3 backdrop-blur-md md:left-4"
            >
            ...
            <motion.div
              ...
              className="absolute -left-2 bottom-24 rounded-sm border border-kreoon-purple-500/25 bg-kreoon-bg-card/70 px-4 py-3 backdrop-blur-md md:bottom-32 md:left-8"
            >
            ...
            <motion.div
              ...
              className="absolute -right-4 bottom-16 rounded-sm border border-green-500/30 bg-kreoon-bg-card/70 px-4 py-2.5 backdrop-blur-md md:right-4"
            >
