...
const PLANS_AGENCIAS: PricingPlan[] = [
  ...
  },
  {
    ...
    priceAnnual: "399",
    priceCustom: false,
    aiTokens: "30,000 tokens IA/mes",
    customApiIncluded: true,
    features: [
      "Hasta 10 clientes/marcas",
  ...
  },
  {
    ...
    priceMonthly: "",
    priceCustom: true,
    aiTokens: "120,000 tokens IA/mes + API propia incluida",
    customApiIncluded: true,
    features: [
      "Clientes ilimitados",
      "Miembros ilimitados",
...
const COMPARISON_FEATURES_MARCAS: ComparisonFeature[] = [
  ...
  { name: "Tokens IA mensuales", values: { "marcas-free": "0", "marcas-starter": "3,000", "marcas-pro": "6,000", "marcas-business": "24,000" } },
...
const COMPARISON_FEATURES_CREADORES: ComparisonFeature[] = [
  ...
  { name: "Tokens IA mensuales", values: { "creadores-basico": "1,500", "creadores-pro": "3,600" } },
...
const COMPARISON_FEATURES_AGENCIAS: ComparisonFeature[] = [
  { name: "Número de clientes", values: { "agencias-starter": "3", "agencias-pro": "10", "agencias-enterprise": "Ilimitados" } },
  { name: "Miembros del equipo", values: { "agencias-starter": "5", "agencias-pro": "15", "agencias-enterprise": "Ilimitados" } },
  { name: "Tokens IA mensuales", values: { "agencias-starter": "12,000", "agencias-pro": "36,000", "agencias-enterprise": "120,000" } },
