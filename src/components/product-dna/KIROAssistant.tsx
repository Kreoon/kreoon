...
export function KIROAssistant({ message, onDismiss }: KIROAssistantProps) {
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: 20 }}
      className="mt-6 rounded-sm border border-purple-500/20 bg-purple-500/5 p-4"
    >
      <div className="flex items-start gap-3">
        <div className="w-8 h-8 rounded-sm bg-gradient-to-br from-purple-500 to-pink-500
