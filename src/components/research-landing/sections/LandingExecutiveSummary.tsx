...
function ScoreGauge({ score }: { score: number }) {
  ...
  return (
    <div className={`flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r ${bg} to-transparent border border-white/[0.06]`}>
        ...
        <div>
          ...
          <div className="space-y-2">
            {actions.slice(0, 5).map((item: any, i: number) => (
              <div key={i} className="flex gap-3 bg-white/[0.03] border border-white/[0.06] rounded-lg p-3">
