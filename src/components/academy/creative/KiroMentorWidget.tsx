...
interface KiroMentorWidgetProps {
  spaceId: string;
  spaceSlug: string;
  /** Ignorado intencionalmente — KIRO es brand voice Kreoon. */
  accentColor?: string;
}
 ...
 * Brand voice 100% Kreoon — no respeta accent del space. Sugiere UN próximo
 * paso concreto en lenguaje motivacional.
 */
export function KiroMentorWidget({ spaceId, spaceSlug }: KiroMentorWidgetProps) {
  ...
  const suggestion = useMemo(() => {
    ...
    if (state.level < 10) {
      return {
        ...
        cta: { label: '🎯 Ver cursos', to: `/academia/${spaceSlug}/classroom` },
      };
    }
  ...
  return (
    <BigCard accentColor={KREOON_PURPLE} glow gradient="purple" className="p-5 md:p-6">
      <div className="flex items-start gap-4 md:gap-5">
        ...
        <div className="relative flex-shrink-0">
          ...
          <div
            ...
            style={{
              borderColor: KREOON_PURPLE,
              background: `radial-gradient(circle at 30% 30%, ${KREOON_PURPLE}80, ${KREOON_PURPLE}30)`,
            }}
          >
